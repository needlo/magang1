                ...
                <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                    ...
                    <div class="trezo-card-content">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[25px]">
                            <div>
                                <a href="my-drive.html" class="block">
                                <div class="bg-primary-50 dark:bg-[#15203c] rounded-md py-[22px] px-[20px]">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <h5 class="!mb-0 !text-[16px] mt-[2px]">
                                                Aryok Suryo
                                            </h5>
                                            <h5 class="!mb-0 !text-[1px] mt-[2px]">
                                                081234567890
                                            </h5>
                                        </div>
                                    </div>
                                    ...
                                    <a href="my-drive.html" class="block">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <h1 class="!mb-0 !text-[20px] mt-[2px]">
                                                    4    
                                                </h1>
                                            </div>
                                        </div>
                                        <div class="mt-[15px] sm:mt-[25px] flex items-center justify-between">
                                            ...
                                            <span class="block text-sm">
                                                Members Dalam Project
                                            </span>
                                            <div class="flex items-center justify-center">
                                                <img src=<?= base_url("assets/images/users/user15.jpg") ?> alt="user-image" class="rounded-full w-[40px] h-[40px] border-[2px] border-gray-100 dark:border-[#172036] -mx-[6px]">
                                                <img src=<?= base_url("assets/images/users/user16.jpg") ?> alt="user-image" class="rounded-full w-[40px] h-[40px] border-[2px] border-gray-100 dark:border-[#172036] -mx-[6px]">
                                                <img src=<?= base_url("assets/images/users/user17.jpg") ?> alt="user-image" class="rounded-full w-[40px] h-[40px] border-[2px] border-gray-100 dark:border-[#172036] -mx-[6px]">
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[17px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]">
                                        <div class="flex items-center gap-[9px]">
                                            <button type="button" class="text-primary-500 leading-none custom-tooltip" id="customTooltip" data-text="file tugas Intern">
                                                <a href="">
                        ...
                        <form>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea class="h-[120px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] py-[14px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500" placeholder="Task description"></textarea>
                                </div>
                            </div>
