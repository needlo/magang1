        ...
        <div class="mx-auto px-[12.5px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1255px] w-full">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-[25px] items-center">
                ...
                <div
                    ...
                    <img src="<?= base_url("assets/images/login-photo.webp") ?>" alt="reset-password-image"
                        class="rounded-[25px]">
                </div>
                ...
                <div class="xl:ltr:pl-[90px] xl:rtl:pr-[90px] 2xl:ltr:pl-[120px] 2xl:rtl:pr-[120px] order-1 lg:order-2">
                    ...
                    <form action="<?= base_url('reset-password/process') ?>" method="post" autocomplete="off">
                        <?= csrf_field(); ?>
                        ...
                        <div class="mb-[15px]">
                            ...
                            <div class="relative block w-full">
                                <input type="password" name="password" id="password" autocomplete="new-password"
                                    value="" placeholder="Masukkan kata sandi baru Anda" required
                        ...
                        <div class="mb-[15px]">
                            ...
                            <div class="relative block w-full">
                                <input type="password" name="confirm_password" id="confirm_password"
                                    autocomplete="new-password" value="" placeholder="Ulangi kata sandi baru Anda"
                                    required
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                                    style="padding-right: 55px; box-shadow: none;">
                        ...
                        <button type="submit" id="reset-btn"
                            class="md:text-md block w-full text-center transition-all rounded-md font-medium my-[20px] md:my-[25px] py-[12px] px-[25px] text-white bg-primary-500 hover:bg-primary-400 opacity-50 cursor-not-allowed"
                            disabled>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateForm() {
                ...
                // KOSONG (Cegah submit jika masih kosong)
