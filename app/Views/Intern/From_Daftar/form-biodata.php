...
<body class="bg-[#f5f6fa] dark:bg-[#15203c]">
    ...
    <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen !ml-0 !w-full pt-[90px] px-[20px] md:px-[25px]"
        ...
        <form action="<?= base_url('pendaftaran/process-biodata') ?>" method="post">
            ...
            <div id="step-1" class="max-w-4xl mx-auto transition-all duration-300 w-full">
                    ...
                    <div class="trezo-card-header mb-[20px] md:mb-[25px]">
                        <div class="trezo-card-title">
                            <h5 class="!mb-0 text-lg">
                                Tahap 1: Informasi Pribadi & Akademik
                            </h5>
                        </div>
                    </div>
                    ...
                    <div class="trezo-card-content">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] sm:gap-[25px]">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" value="<?= $pendaftaran['name'] ?? '' ?>" required
                            ...
                            <div>
                                ...
                                <input type="text" name="domisili" value="<?= $pendaftaran['domisili'] ?? '' ?>"
                                    required
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <input type="tel" name="no_hp" value="<?= $pendaftaran['no_hp'] ?? '' ?>" required
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <input type="text" name="institusi" value="<?= $pendaftaran['institusi'] ?? '' ?>"
                                    required
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <input type="text" name="jurusan" value="<?= $pendaftaran['jurusan'] ?? '' ?>" required
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <input type="text" name="minat_posisi" value="<?= $pendaftaran['minat_posisi'] ?? '' ?>"
                                    required
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <input type="url" name="linkedin" value="<?= $pendaftaran['linkedin'] ?? '' ?>"
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <input type="url" name="github" value="<?= $pendaftaran['github'] ?? '' ?>"
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[15px]">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="tanggal_selesai"
                                        value="<?= $pendaftaran['tanggal_selesai'] ?? '' ?>" required
                                        class="h-[55px] rounded-md border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[13px] block w-full outline-0 cursor-pointer transition-all focus:border-primary-500 text-gray-500 dark:text-gray-400">
                                </div>
                ...
                <div class="flex items-center justify-end mb-[25px]">
                    ...
                    <button type="submit"
                        class="font-medium inline-block transition-all rounded-md md:text-md ltr:mr-[15px] rtl:ml-[15px] py-[10px] md:py-[12px] px-[20px] md:px-[22px] bg-primary-500 text-white hover:bg-primary-400">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fields.forEach(field => {
                ...
                field.addEventListener('change', function () {
                    ...
                    fetch("<?= base_url('pendaftaran/autosave') ?>", {
